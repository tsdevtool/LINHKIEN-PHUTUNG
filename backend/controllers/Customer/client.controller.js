...
export const getProductListByChild = async (req, res) => {
  try {
...
// export const getProductListByParent = async (req, res) => {
//   try {
//     // Lấy id từ tham số URL
//     const parentId = req.params.parentId;

//     // Kiểm tra nếu parentId hợp lệ (ObjectId hợp lệ)
//     if (!parentId || !mongoose.Types.ObjectId.isValid(parentId)) {
//       return res.status(400).json({
//         success: false,
//         message: "ID không hợp lệ. Vui lòng nhập một ObjectId hợp lệ."
//       });
//     }

//     // Tìm các danh mục có parent_id khớp với parentId
//     const childCategories = await Category.find({ parent_id: parentId });

//     // Kiểm tra nếu không tìm thấy danh mục con
//     if (!childCategories || childCategories.length === 0) {
