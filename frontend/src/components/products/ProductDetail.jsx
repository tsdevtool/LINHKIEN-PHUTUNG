...
const ProductDetailC = () => {
  ...
  const handleAddToCart = () => {
    toast.success(`Đã thêm ${itemQuantity} ${product.name} vào giỏ hàng!`);
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 md:p-8 bg-white rounded-xl shadow-lg mt-10">
      {/* Nút quay lại */}
      <button 
          onClick={handleGoBack}
          className="flex items-center justify-center mb-6 p-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-all duration-300 text-gray-700"
        >
          <FaArrowLeft />
      </button>
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="lg:w-2/5">
          <div className="relative group">
            <img
              src={mainImage}
              alt={product.name}
              className="w-full h-[500px] object-cover rounded-xl shadow-md transition-all duration-300 group-hover:shadow-xl"
            />
            <button 
          ...
          <div className="flex gap-3 mt-5 overflow-x-auto pb-2 scrollbar-hide">
            {thumbnailImages.length > 0 ? (
              thumbnailImages.map((img, index) => (
                <div
                  key={index}
                  className={`min-w-[100px] border-2 rounded-lg overflow-hidden cursor-pointer transition-all duration-300 hover:scale-105 ${
        ...
        <div className="lg:w-3/5">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-6">
            ...
            <div className="bg-red-100 text-red-600 px-4 py-1 rounded-full font-semibold text-sm">
              Top sale
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              {product.styles?.map((style, index) => (
                <button 
                  key={index} 
                  className={`px-5 py-3 border rounded-lg transition-all duration-300 ${
                    selectedStyle === style 
          ...
          <div className="flex items-center gap-2 mb-8">
            ...
            {product.quantity > 0 ? (
              ...
              <div className="text-red-500 font-semibold">Hết hàng</div>
            )}
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <button 
              ...
              className="flex-1 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-4 px-8 rounded-lg transition-colors duration-300 flex items-center justify-center gap-2"
